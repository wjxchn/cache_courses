...
public class BookQuery extends JFrame{
	...
	public BookQuery(){
		...
		querybtn.setBounds(1000,30,50,20);
		closebtn.setBounds(1100,30,50,20);
	...
	String[] informationoption={"id","bookname","booktype","author","translator","publisher","publish_time","price","num","page"};
		int i=0;
		while(rs.next()){
		...
		DBset.close();
			...
			JOptionPane.showMessageDialog(null,"找不到相关的信息");
		}
	}

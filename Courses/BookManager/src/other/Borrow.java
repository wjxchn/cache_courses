...
public class Borrow extends Frame {
	...
	String[] optionname = { "图书书名：", "图书作者：", "出版社：", "出版时间：", "定价：", "剩余数量：", "姓名：",
	...
	public void queryActionPerformed(ActionEvent e) {
		...
		if (IfBorrowBack.findBook(bookid, readerid)) {
			...
			JOptionPane.showMessageDialog(null, book.getBookname() + "已被" + reader.getReadername() + "借阅" + fulldays + "天，且还未归还，该读者不能借阅此图书");
			setInitialize();
			return;
		} else {

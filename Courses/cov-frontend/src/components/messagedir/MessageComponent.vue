    ...
    <div class="container">
      <div class="row">
        <div class="col-12 mt-4">
          <h1 style="font-family: 'rr';">防控知识</h1>
        </div>
      </div>
      <div id="portfolio-grid" class="row no-gutter" data-aos="fade-up" data-aos-delay="200">
        <vlist :datalist="messageList" v-slot="items">
          <div class="block" @click="toMessageDetail(items.item.id)">
...
export default {
  ...
  mounted () {
    var that = this;
    this.postRequest('/knowledge/getallknowledge')
      .then((response) => {
